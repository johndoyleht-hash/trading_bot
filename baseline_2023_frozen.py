...
DATA_CSV_PATH   = "data/clean/EURUSD/2023/EURUSD_1y_2023_clean.csv"   # change per run
...
EXCLUDE_UTC_HOURS  = {11, 12}   # {11,12,13} also worked for you
...
# (Optional) dynamic wider SL (leave False)
DYN_SL_ENABLE          = False
